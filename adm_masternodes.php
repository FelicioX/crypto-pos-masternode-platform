        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Criar Masternode</div>
            <div class="card-body">
              <div class="table-responsive">
                <div id="tabela">
				  <table class="table table-bordered" width="100%" cellspacing="0">
					<thead><tr><th>Moeda</th><th>Collateral</th><th>Ação</th><tr></thead>
					<tbody>
						<tr><td><?php echo listaMMn(); ?></td><td><span id='collateral'></span></td><td><input class="btn btn-primary" value="CRIAR" onClick='criarMn()' /></td></tr>
					</tbody>
				  </table>
				</div>
              </div>
