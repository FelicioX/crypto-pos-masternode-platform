		...
		<!-- DataTables Example -->
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div id='iniciclo' >
					<button data-toggle="modal" data-target="#myModal" class="btn btn-default" id='btini' onClick='iniciarCicloModal();'><b>Iniciar Ciclo</b></button>
				</div>
              </div>
            </div>
...
function iniciarCicloModal(){
	$('#mtitulo').html('Iniciar Ciclo');
    var dados = 0;
	$.ajax({
		type: 'POST',
		//dataType: 'json',
		url: 'ajax/modal_iniciarciclo.php',
		async: true,
		data: dados,
...
function abrirDetalhesCiclo(ciclo, moeda, id){
	
	$('#mtitulo').html("Ciclo " + ciclo + " - " + moeda);
    var mm = {idd:id};
	var dados = mm;
	$.ajax({
		type: 'POST',
		//dataType: 'json',
		url: 'ajax/detalhes_ciclo.php',
		async: true,
		data: dados,
		success: function(response) {
			//location.reload();
...
function finalizarCiclo(x,y,z){
	var mm = {id:x,ciclo:y,moeda:z};
	var dados = mm;
	$.ajax({
		type: 'POST',
		//dataType: 'json',
		url: 'ajax/finalizar_ciclo.php',
		async: true,
		data: dados,
		success: function(response) {
			//location.reload();
