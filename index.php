    ...
    <div id="wrapper" style='padding-top: 0px; margin-top: 0px;'>
      ...
      <div id="content-wrapper" style='padding-top: 0px; margin-top: 0px;'>
		...
		<div style='text-align: center; margin: 0 auto;'>
			<a href='login.php' class='bt-index'>Login</a> <a href='cadastro.php' class='bt-index'>Register</a> <a href='sobre.php' class='bt-index'>About Us</a> <a href='https://docs.google.com/forms/d/e/1FAIpQLSdJNEyjrTS9WKFqglZw2HoAOf13YRIFjSccfpoKv9YHPsEZ9Q/viewform' target='_blank' class='bt-index'>Add New Coin</a> 
		</div>
		<br>
		...
		<div style='font-weight: bold; text-align: center; color: #fff; font-size: 18px;'>MASTERNODES</div>
		<div style='text-align: center;'>
			<?php echo $mn; ?>
		</div>
